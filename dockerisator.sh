...
curl --user admin:admin "http://localhost:3000/api/datasources" -X POST -H 'Content-Type: application/json;charset=UTF-8' --data-binary '{"name":"test","isDefault":true ,"type":"loki","url":"http://loki:3100","access":"proxy","basicAuth":false}'
echo "
